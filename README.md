...
- Eclipse EE
- [Tomcat 10.1.31](https://dlcdn.apache.org/tomcat/tomcat-10/v10.1.31/bin/apache-tomcat-10.1.31-windows-x64.zip)
- MySQL workbench

###  Jar files used :
- [mysql-connector-j-8.0.31](./src/main/webapp/WEB-INF/lib/mysql-connector-j-8.0.31.jar)
- [angus-activation-2.0.1](./src/main/webapp/WEB-INF/lib/angus-activation-2.0.1.jar)
- [jakarta.activation-api-2.1.2](./src/main/webapp/WEB-INF/lib/jakarta.activation-api-2.1.2.jar)
- [jakarta.mail-2.0.1](./src/main/webapp/WEB-INF/lib/jakarta.mail-2.0.1.jar)
- [jakarta.servlet-api-6.0.0.jar](./src/main/webapp/WEB-INF/lib/jakarta.servlet-api-6.0.0.jar)
